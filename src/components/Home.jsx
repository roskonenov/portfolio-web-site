    ...
    return (
        <div name='home' className='w-full h-screen bg-[#335c67]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                <p className='text-[#9e2a2b] text-2xl'>Hi, my name is</p>
                <h1 className='text-2xl sm:text-7xl font-bold text-[#fff3b0]'>Rosen Nenov</h1>
                <h2 className='text-4xl sm:text-7xl font-bold text-[#e09f3e]'>I'm a Full Stack Developer</h2>
